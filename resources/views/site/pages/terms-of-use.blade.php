...
@section('content')
    ...
    <p class="lead">5.2. Стоимость платных услуг определяется Администрацией и зависит от конкретной услуги. Стоимость конкретной услуги доводится до сведения Пользователей заранее до выражения Пользователем согласия с предоставлением такой услуги
    </p>
